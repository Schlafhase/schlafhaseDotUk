function updatePronouns() {
    ...
    smallText.innerHTML = `${pronouns[pronounIndex][0]} ${pronouns[pronounIndex][3]} coding. ${pronouns[pronounIndex][1]} code is very messy sometimes. Ndim is an esoteric programming language created by ${pronouns[pronounIndex][2]}.`;
}